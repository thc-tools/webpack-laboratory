...
const prepareEntries = (env, entries) => {
    return (env.HOT_RELOAD === 'true' ? ['@thc/webpack-react/lib/override/react-hot-dev-client', 'react-error-overlay', 'webpack/hot/only-dev-server'] : []).concat(entries);
};
